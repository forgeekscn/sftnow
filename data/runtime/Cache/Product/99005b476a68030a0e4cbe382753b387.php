        ...
        <div>
            <table class="table table-hover table-bordered table-list">
                ...
                <?php if(is_array($productE)): foreach($productE as $key=>$vo): ?><tr>
                        ...
                        <td width="350px"><img src="<?php echo ($url1); ?>" width="350px" /> <?php echo ($vo["title"]); ?></td>
                        <td width="300px"> <?php echo ($vo["content"]); ?> </td>
                        <td width="2=300px"> <?php echo ($vo["extendcontent03"]); ?> </td>
                        <td width="200px"> <a href="<?php echo U('AdminIndex/editE');?>">编辑</a> |
                            <a href=" ">删除</a></td>
