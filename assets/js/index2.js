...
//导航条内容加载
var navBarOption={
    bianLiang:{"navContent":["首页","关于我们","公司动态","产品中心","工程案例","加入我们","OA系统"]},
...
var footer={
    bianliang:{"产品中心":["预设填充","预设填充","预设填充","预设填充","预设填充","预设填充","预设填充","预设填充","预设填充"],"企业简介":["董事长致辞","组织结构","品质保障","公司简介","资质荣誉"],"成功案例":["成功案例"],"服务项目":["服务项目","OA登陆"],"招纳贤士":["社会招聘","校园招聘"]},
